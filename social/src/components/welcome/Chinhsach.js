...
LANA.VN thu thập thông tin nhằm cung cấp sản phẩm, dịch vụ tốt hơn cho các Bạn, từ việc tìm hiểu những thông tin cơ bản như thông tin cá nhân: họ và tên, giới tính, ngày sinh; Thông tin liên lạc: số điện thoại, địa chỉ gửi thư, địa chỉ email; Thông tin về thanh toán: thông tin chuyển khoản, mã số thẻ cào; hay các thông tin cá nhân được tự động tạo ra khi Bạn sử dụng website.<br/><br/>
                  </h6>
